...
public class DepTxnHandlerTest {
	DepTxnHandler depTxnHandler;

	@Before
	public void setUp() throws Exception {
		depTxnHandler = new DepTxnHandler();
	}
	...
	public void testDepTxnHandler() {
		...
		Transaction transaction = new Transaction("NEAA0000", LocalDate.of(2017, 01, 01),"DEP", new BigDecimal("500"), "CASH",new BigDecimal("1"),true);

		depTxnHandler.process(holdingMap, transaction);
		...
		assertEquals("NEAA0000CASH should have holding of ", 600, holding.getHolding(), 0.1);
