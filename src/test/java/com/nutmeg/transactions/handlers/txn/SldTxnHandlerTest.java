...
public class SldTxnHandlerTest {
	...
	public void testSldTxnHandler() {
		...
		Transaction transaction = new Transaction("NEAA0000", LocalDate.of(2017, 01, 01), "SLD", new BigDecimal("15"),
		...
		assertEquals("NEAA0000 CASH should have holding of ", 122.5, holding.getHolding(), 0.1);
		...
		assertEquals("NEAA0000 VUSA should have holding of ", 15, holding.getHolding(), 0.1);
